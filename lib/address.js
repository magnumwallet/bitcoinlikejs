 ...
 */
function WIFToPrivKeyObj(wifPk) {
  var result = { compressed: true };
  var og = bs58check.decode(wifPk, 'hex').toString('hex');
  var wifBytes = zconfig.mainnet.wif.length;
...
function multiSigRSToAddress(redeemScript) {
  var scriptHash = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : zconfig.mainnet.scriptHash;
