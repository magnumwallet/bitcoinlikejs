# bitcoinlikejs ![build status](https://api.travis-ci.org/magnumwallet/bitcoinlikejs.svg?branch=master)
Dead simple and easy to use JavaScript based library for bitcoin like coins. Inspired by [zencashjs](https://github.com/ZencashOfficial/zencashjs)

# Example usage (Transparent address)
```javascript
var bitcoinlikejs = require('bitcoinlikejs')

var priv = bitcoinlikejs.address.mkPrivKey('chris p. bacon, defender of the guardians')
// 2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c

var privWIF = bitcoinlikejs.address.privKeyToWIF(priv)
// 5J9mKPd531Tk4A73kKp4iowoi6EvhEp8QSMAVzrZhuzZkdpYbK8

var pubKey = bitcoinlikejs.address.privKeyToPubKey(priv, true) // generate compressed pubKey
// 038a789e0910b6aa314f63d2cc666bd44fa4b71d7397cb5466902dc594c1a0a0d2

var zAddr = bitcoinlikejs.address.pubKeyToAddr(pubKey)
...
// bitcoinlikejs.transaction.serializeTx(txobj)
...
var tx0 = bitcoinlikejs.transaction.signTx(txobj, 0, '2c3a48576fe6e8a466e78cd2957c9dc62128135540bbea0685d7c4a23ea35a6c', true) // The final argument sets the `compressPubKey` boolean. It is `false` by default.
// bitcoinlikejs.transaction.serializeTx(tx0)
...
var redeemScript = bitcoinlikejs.address.mkMultiSigRedeemScript(pubKeys, 2, 3)
...
var multiSigAddress = bitcoinlikejs.address.multiSigRSToAddress(redeemScript)
...
// var txBytes = bitcoinlikejs.transaction.serializeTx(txobj)
// var txObj = bitcoinlikejs.transaction.deserializeTx(txBytes)
...
var z_secretKey = bitcoinlikejs.zaddress.mkZSecretKey('Z pigs likes to snooze. ZZZZ')
// 0c10a61a669bc4a51000c4c74ff58c151912889891089f7bae5e4994a73af7a8

// Spending key (this is what you import into your wallet)
var spendingKey = bitcoinlikejs.zaddress.zSecretKeyToSpendingKey(z_secretKey)
// SKxtHJsneoLByrwME9Nh4cd4AvYLNK9jJkAnB3AHNW794udD1qpx

// Paying key
var a_pk = bitcoinlikejs.zaddress.zSecretKeyToPayingKey(z_secretKey)
// 927a3819627247c0dd39102ec5449fc6fc952e242aad08615df9f26718912e27

// Transmission key
var pk_enc = bitcoinlikejs.zaddress.zSecretKeyToTransmissionKey(z_secretKey)
// 22d666c34ababacf6a9a4a752cc7870b505b64e85638aa45d23ac32992397960

var Zaddress = bitcoinlikejs.zaddress.mkZAddress(a_pk, pk_enc)
...
git clone https://github.com/magnumwallet/bitcoinlikejs.git
cd bitcoinlikejs
yarn install
yarn run [dev | build]
```
